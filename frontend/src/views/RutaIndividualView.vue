<template>
  <main class="container-fluid p-4">
    ...
    <section class="mb-5 p-4 bg-white border rounded shadow-sm">
      ...
      <p>
        <i class="bi bi-signpost me-2 text-success"></i><strong>Distancia:</strong>
        {{ ruta.distanciaKm }} km
      </p>
      <p>
        <i class="bi bi-clock me-2 text-success"></i><strong>Duración estimada:</strong>
        {{ ruta.duracionEstimada }} h
      </p>
      <p>
        <i class="bi bi-bar-chart-line me-2 text-success"></i><strong>Dificultad:</strong>
        {{ ruta.dificultad }}
      </p>
      <p>
        <i class="bi bi-arrow-up me-2 text-success"></i><strong>Altitud:</strong>
        {{ ruta.altitud }} m
      </p>
      <p>
        <i class="bi bi-info-circle me-2 text-success"></i><strong>Descripción:</strong>
        {{ ruta.descripcion }}
      </p>
      <p>
        <i class="bi bi-geo-alt me-2 text-success"></i><strong>Modo de viaje:</strong>
        {{ tipoRuta }}
      </p>
    </section>
  ...
  methods: {
    async enviarComentario() {
      ...
      try {
        ...
        await axios.post(
          `http://localhost:3000/api/rutas/${rutaId}/comentarios`,
          {
